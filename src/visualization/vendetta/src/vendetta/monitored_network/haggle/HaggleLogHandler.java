 ...
 * 
 * This class provides methods to parse and maybe visualize log events that were
 * created by a node client. The methods are dependent on the actual log
 * messages and thus depend on the application running on the sensor nodes.
 * 
