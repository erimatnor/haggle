 ...
 * @version $Id$
 */
public class BulkForkOneThread implements Runnable {
    ...
    /**
     * Create a new BulkForkOneThread.
     *
     ...
     */
    public BulkForkOneThread(BulkForkWindow win, String[] commands,
        ...
        while (done < to_do) {
            ...
            if (started == done) {
                ...
                if (free_p != -1) {
                    ...
                    try {
                        timeouts[free_p] = System.currentTimeMillis() +
                            TIMEOUT;
