...
public class DrawingSurface {
    ...
    public void pushBounds(double x1, double y1, double x2, double y2) {
        pushBounds(new Rect(x1, y1, x2, y2));
    }

    public void pushBounds(double x1, double y1, double x2, double y2,
        double xScale, double yScale) {
        pushBounds(new Rect(x1 * xScale, y1 * yScale, x2 * xScale, y2 * yScale));
    }
    ...
    public void drawString(String str, double x, double y, double scale, Color c) {
        g.setColor(c);
    ...
    public void drawString(String str, Coordinate p, double scale,
        Color textCol, Color bgCol) {
        fillRect(measureString(str, p, scale), bgCol);
        drawString(str, p, scale, textCol);
    }

    public void drawString(String str, double x, double y, double scale,
        Color textCol, Color bgCol) {
        drawString(str, new Coordinate(x, y), scale, textCol, bgCol);
    }

    public void drawStringTopLeft(String str, Coordinate p, double scale,
        Color c) {
        Rect r;
    ...
    public void drawStringTopLeft(String str, double x, double y, double scale,
        Color c) {
    ...
    public void drawStringTopLeft(String str, Coordinate p, double scale,
        ...
        r = measureString(str, 0, 0, scale);
        p = new Coordinate(p.x - r.left, p.y - r.top);
        r = new Rect(p.x - r.left, p.y + r.top, p.x - r.left + r.width,
                p.y + r.top + r.height);
        fillRect(r, bgCol);
        drawString(str, p, scale, textCol);
    }
    ...
    public void drawStringCentered(String str, Coordinate p, double scale,
        Color c) {
        Rect r;
        r = measureString(str, 0, 0, scale);
        p = new Coordinate(p.x - ((r.right - r.left) / 2.0),
    ...
    public void drawStringCentered(String str, double x, double y,
        double scale, Color textCol, Color bgCol) {
    ...
    public void drawLine(Coordinate p1, Coordinate p2, double width, Color c) {
        ...
        g.fill(createQuad(p1a.x, p1a.y, p1b.x, p1b.y, p2b.x, p2b.y, p2a.x, p2a.y));
    }
    ...
    public void drawLine(Coordinate[] p, double width, Color c) {
        ...
        for (i = 1; i < p.length; i++) {
            ...
            g.fill(createQuad(p1a.x, p1a.y, p1b.x, p1b.y, p2b.x, p2b.y, p2a.x,
                    p2a.y));
        }
    }

    public void drawLine(Coordinate p1, double startDistance, Coordinate p2,
        double stopDistance, double width, Color c) {
        if ((p1 == null) || (p2 == null)) {
            return;
        }
        ...
        drawLine(a, b, width, c);
    }

    private Coordinate[] calculateBentLine(Coordinate p1, Coordinate p2,
        Coordinate displace, int segments) {
    ...
    public void drawBentLine(Coordinate p1, Coordinate p2, double width,
        Coordinate displace, int segments, Color c) {
        Coordinate[] p;

        p = calculateBentLine(p1, p2, displace, segments);
        drawLine(p, width, c);
    }

    public void drawArrow(double x1, double y1, double head_size_1, double x2,
        double y2, double head_size_2, double width, Color c) {
        drawArrow(new Coordinate(x1, y1), head_size_1, new Coordinate(x2, y2),
            head_size_2, width, c);
    }

    public void drawArrow(Coordinate[] p, double head_size_1,
        double head_size_2, double width, Color col) {
        if (p.length > 1) {
    ...
    public void drawArrow(Coordinate p1, double head_size_1, Coordinate p2,
        double head_size_2, double width, Color col) {
        Coordinate a;
        Coordinate b;
        Coordinate c;
    ...
    public void drawArrow(Coordinate p1, double startDistance,
        double head_size_1, Coordinate p2, double stopDistance,
        double head_size_2, double width, Color c) {
        if ((p1 == null) || (p2 == null)) {
            return;
        }
        ...
        drawArrow(a, head_size_1, b, head_size_2, width, c);
    }

    public void drawBentArrow(Coordinate p1, double head_size_1, Coordinate p2,
        double head_size_2, double width, Coordinate displace, int segments,
        Color c) {
        Coordinate[] p;
    ...
    public Rect drawRect(Coordinate p1, Coordinate p2, double width, Color c) {
        if ((p1 == null) || (p2 == null)) {
            return null;
        }

        return drawRect(p1.x, p1.y, p2.x, p2.y, width, c);
    }

    public Rect drawRect(Rect r, double width, Color c) {
        if (r == null) {
            return null;
        }

        return drawRect(r.left, r.top, r.right, r.bottom, width, c);
    }

    public Rect drawRect(double x1, double y1, double x2, double y2,
        double width, Color c) {
        g.setColor(c);
    ...
    public Rect fillRect(Coordinate p1, Coordinate p2, Color c) {
        return fillRect(p1.x, p1.y, p2.x, p2.y, c);
    }
    ...
    public void fillRect(double edgeWidth, Color edgeColor, Color col) {
...

        {
            ...
            g.fill(new Rectangle2D.Double(_x1, _y1, _x2 - _x1, _y2 - _y1));
        }
    ...
    public Rect fillRect(Coordinate p1, Coordinate p2, double edgeWidth,
        Color edgeColor, Color c) {
        pushBounds(p1.x, p1.y, p2.x, p2.y);
        fillRect(edgeWidth, edgeColor, c);

        return popBounds();
    }

    public Rect fillRect(Rect r, Color c) {
        return fillRect(r.left, r.top, r.right, r.bottom, c);
    }
    ...
    public Rect drawImageInRect(Rect r, BufferedImage im) {
        return drawImageInRect(r.left, r.top, r.right, r.bottom, im);
    }
    ...
    public Rect fillOval(Rect r, Color c) {
        return fillOval(r.topLeft(), r.bottomRight(), 0.0, null, c);
    }

    public Rect fillOval(Coordinate p1, Coordinate p2, Color c) {
        return fillOval(p1, p2, 0.0, null, c);
    }

    public Rect fillOval(Coordinate p1, Coordinate p2, double edgeWidth,
        Color edgeColor, Color c) {
        return fillOval(p1.x, p1.y, p2.x, p2.y, edgeWidth, edgeColor, c);
    }

    public Rect fillOval(double x1, double y1, double x2, double y2, Color c) {
        return fillOval(x1, y1, x2, y2, 0.0, null, c);
    }

    public Rect fillOval(double x1, double y1, double x2, double y2,
        double edgeWidth, Color edgeColor, Color c) {
    ...
    public Rect fillCircle(Coordinate p, double diameter, double edgeWidth,
        Color edgeColor, Color c) {
        return fillCircle(p.x, p.y, diameter, edgeWidth, edgeColor, c);
    }

    public Rect fillCircle(double x, double y, double diameter, Color c) {
        return fillCircle(x, y, diameter, 0.0, null, c);
    }

    public Rect fillCircle(double x, double y, double diameter,
        double edgeWidth, Color edgeColor, Color c) {
        double radius = diameter / 2.0;
        pushBounds(x - radius, y - radius, x + radius, y + radius);
        fillOval(edgeWidth, edgeColor, c);

        return popBounds();
    }

    public void fillOval(Color col) {
    ...
    public void fillOval(double edgeWidth, Color edgeColor, Color col) {
...

        {
            ...
            double _x2 = convertX(1.0);
            double _y2 = convertY(1.0);
            g.fill(new Ellipse2D.Double(_x1, _y1, _x2 - _x1, _y2 - _y1));
        }
    ...
    public Rect fillCube(Coordinate p, double size, Color surfaceColor) {
        return fillCube(p, size, 0.0, null, surfaceColor);
    }

    public Rect fillCube(Coordinate p, double size, double edgeWidth,
        Color edgeColor, Color surfaceColor) {
        return fillCube(p.x - (size / 2), p.y - (size / 2), p.x + (size / 2),
            p.y + (size / 2), edgeWidth, edgeColor, surfaceColor);
    }

    public Rect fillCube(Coordinate p1, Coordinate p2, Color surfaceColor) {
        return fillCube(p1, p2, 0.0, null, surfaceColor);
    }

    public Rect fillCube(Coordinate p1, Coordinate p2, double edgeWidth,
        Color edgeColor, Color surfaceColor) {
        return fillCube(p1.x, p1.y, p2.x, p2.y, edgeWidth, edgeColor,
            surfaceColor);
    }

    public Rect fillCube(double x1, double y1, double x2, double y2,
        Color surfaceColor) {
        return fillCube(x1, y1, x2, y2, 0.0, null, surfaceColor);
    }

    public Rect fillCube(double x1, double y1, double x2, double y2,
        double edgeWidth, Color edgeColor, Color surfaceColor) {
        pushBounds(x1, y1, x2, y2);
        fillCube(edgeWidth, edgeColor, surfaceColor);
    ...
    public void fillCube(double edgeWidth, Color edgeColor, Color surfaceColor) {
        ...
        g.fill(createHex(0.5, 0.0, 1.0, 0.25, 1.0, 0.75, 0.5, 1.0, 0.0, 0.75,
                0.0, 0.25));
        ...
        if (drawEdge) {
            ...
            g.fill(createQuad(0.5, 0.0 + edgeWidth, 1.0 - topEdgeWidth, 0.25,
                    0.5, 0.5 - edgeWidth, 0.0 + edgeWidth, 0.25));
            g.fill(createQuad(0.0 + edgeWidth, 0.25 + edgeWidth,
                    0.5 - edgeWidth, 0.5, 0.5 - edgeWidth, 1.0 - edgeWidth,
                    0.0 + edgeWidth, 0.75 - edgeWidth));
            g.fill(createQuad(1.0 - edgeWidth, 0.25 + edgeWidth,
                    0.5 + edgeWidth, 0.5, 0.5 + edgeWidth, 1.0 - edgeWidth,
